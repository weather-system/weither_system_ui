        ...
        <ul>
          ...
          <li>
            <a href="index.html" class="active"
              ><i class="fe fe-grid"></i> <span>Dashboard</span></a
            >
          </li>
          <li class="menu-title">
            <h6>Services</h6>
          ...
          <li>
            <a href="sub-categories.html"
              ><i class="fe fe-clipboard"></i> <span>Sub Categories</span></a
            >
          </li>
          <li class="submenu">
          ...
          <li>
            <a href="sales-transactions.html"
              ...
              <span>Sales Transactions</span></a
            >
          </li>
          <li>
          ...
          <li>
            <a href="chat.html"
              ><i class="fe fe-message-square"></i> <span>Chat</span></a
            >
          </li>
          <li class="menu-title">
            <h6>Content</h6>
          ...
          <li>
            <a href="testimonials.html"
              ><i class="fe fe-star"></i> <span>Testimonials</span></a
            >
          </li>
          <li>
            <a href="faq.html"
              ><i class="fe fe-help-circle"></i> <span>FAQ</span></a
            >
          </li>
          <li class="menu-title">
            <h6>Membership</h6>
          ...
          <li>
            <a href="membership.html"
              ><i class="fe fe-user"></i> <span>Membership</span></a
            >
          </li>
          <li>
            <a href="membership-addons.html"
              ><i class="fe fe-user-plus"></i> <span>Membership Addons</span></a
            >
          </li>
          <li class="menu-title">
            <h6>Reports</h6>
          ...
          <li class="submenu">
            ...
            <ul>
              ...
              <li>
                <a href="user-providers.html">Providers </a>
              </li>
            </ul>
          </li>
          <li>
            <a href="roles-permissions.html"
              ><i class="fe fe-file"></i> <span>Roles & Permissions</span></a
            >
          </li>
          <li>
            <a href="delete-account-requests.html"
              ><i class="fe fe-trash-2"></i>
              <span>Delete Account Requests</span></a
            >
          </li>
          <li class="menu-title">
            <h6>Marketing</h6>
          ...
          <li>
            <a href="marketing-coupons.html"
              ><i class="fe fe-bookmark"></i> <span>Coupons</span></a
            >
          </li>
          <li>
            <a href="marketing-service.html"
              ><i class="fe fe-briefcase"></i> <span>Service Offers</span></a
            >
          </li>
          <li>
            <a href="marketing-featured.html"
              ><i class="fe fe-briefcase"></i> <span>Featured Services</span></a
            >
          </li>
          <li>
            <a href="marketing-newsletter.html"
              ><i class="fe fe-mail"></i> <span>Email Newsletter</span></a
            >
          </li>
          <li class="menu-title">
            <h6>Management</h6>
          ...
          <li>
            <a href="email-templates.html"
              ><i class="fe fe-mail"></i> <span>Email Templates</span></a
            >
          </li>
          <li>
            <a href="sms-templates.html"
              ><i class="fe fe-message-square"></i>
              <span>SMS Templates</span></a
            >
          </li>
          <li class="menu-title">
            <h6>Support</h6>
          ...
          <li>
            <a href="abuse-reports.html"
              ><i class="fe fe-file-text"></i> <span>Abuse Reports</span></a
            >
          </li>
          <li>
            <a href="announcements.html"
              ><i class="fe fe-volume-2"></i> <span>Announcements</span></a
            >
          </li>
          <li class="menu-title">
            <h6>Settings</h6>
          ...
          <li>
            <a href="signin.html"
              ><i class="fe fe-log-out"></i> <span>Logout</span></a
            >
          </li>
        </ul>
      </div>
