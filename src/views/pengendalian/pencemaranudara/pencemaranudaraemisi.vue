...
const formData = ref({
  ...
  pencemaranudaraDetails: [
    {
      parameter_udara: 'Partikulat',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Sulfur Dioksida',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Laju Air',
      satuan: 'm/s',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Amonia (NH3)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Gas Klorin (CI2)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Hidrogen Klorida (HCI)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Hidrogen Fluorida (HF)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Opasitas',
      satuan: '%',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Total Sulfur Tereduksi/Total Reduced Sulfur (H2S)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Air Raksa (Hg)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Arsen (As)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Antimon (Sb)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Cadmium (Cd)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    ...
    {
      parameter_udara: 'Timah Hitam (Pb)',
      satuan: 'mg/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <div class="content-page-header mb-2">
              <h3>Tambah Pemantauan Pencemaran Udara - Emisi</h3>
            </div>
