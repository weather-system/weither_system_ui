        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <div class="content-page-header mb-2">
              <h3>Detail Pemantauan Pencemaran Udara - Fly Ash, Bottom Ash dan Sludge</h3>
            </div>
              ...
              <table class="table table-bordered mb-4">
                ...
                <tbody>
                  <tr v-for="(detail, index) in formData.details" :key="index">
                    ...
                    <td>{{ detail.ekspresi2 || '-' }}</td>
                    <td>{{ detail.hasil_pengujian2 || '-' }}</td>
                    <td>{{ detail.ekspresi3 || '-' }}</td>
                    <td>{{ detail.hasil_pengujian3 || '-' }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
