...
const formData = ref({
  ...
  pencemaranudaraDetails: [
    {
      parameter_udara: 'Sulfur Dioksida (So2)',
      kelompok: 'Pencemar Udara',
      satuan: 'ug/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    },
    {
      parameter_udara: 'Karbon Monoksida (CO)',
      kelompok: 'Pencemar Udara',
      satuan: 'ug/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    ...
    {
      parameter_udara: 'Nitrogen Dioksida (NO2)',
      kelompok: 'Pencemar Udara',
      satuan: 'ug/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    ...
    {
      parameter_udara: 'Pb (Timbal Hitam)',
      kelompok: 'Pencemar Udara',
      satuan: 'ug/Nm3',
      ekspresi1: '',
      hasil_pengujian1: ''
    ...
    {
      parameter_udara: 'Hidrogen Sulfida (H2S)',
      kelompok: 'Kebauan',
      satuan: 'ppm',
      ekspresi1: '',
      hasil_pengujian1: ''
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <div class="content-page-header mb-2">
              <h3>Tambah Pemantauan Pencemaran Udara - Ambien</h3>
            </div>
