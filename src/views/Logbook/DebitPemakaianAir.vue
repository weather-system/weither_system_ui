...
const debitPemakaianAir = ref([])

onMounted(async () => {
  const loader = $loading.show()
  try {
    // Dummy data, ganti dengan panggilan API Anda
    debitPemakaianAir.value = [
      {
        id: 1,
    ...
    <div class="page-wrapper page-settings">
      <div class="content">
        ...
        <div class="content-page-header content-page-headersplit">
          <h5>Debit Pemakaian Air</h5>
          <div class="list-btn">
            <ul>
              <li>
                <RouterLink
                  class="btn btn-primary"
                  to="/Logbook/DebitPemakaianAir/Create"
                >
          ...
          <div class="col-12">
            <div class="table-responsive table-div">
              <table class="table datatable">
                ...
                <tbody>
                  <tr v-for="data in debitPemakaianAir" :key="data.id">
                    <td>{{ data.company }}</td>
