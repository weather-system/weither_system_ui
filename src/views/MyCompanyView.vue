...
const submitForm = async () => {
  if (!$loading.isActive) {
    ...
    try {
      ...
      const response = await axios.post('/api/companies/details', data, {
        headers: {
...
<template>
  <!-- konten udah isi inputan sama diterima -->
                              ...
                              <div class="form-group">
                                ...
                                <div class="row mt-3">
                                  <div
                                    class="col-md-6"
                                    v-if="
                                      formData.source.includes('PDAM Lainnya')
                                    "
                                  >
                                    <div class="form-group">
                                      <label class="col-form-label"
